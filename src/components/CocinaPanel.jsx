...
const CocinaPanel = ({ onBack, setRoute }) => {
    ...
    try {
      ...
      if (pedidosAnteriores.length > 0) {
        ...
        if (nuevosPedidosDetectados.length > 0) {
          ...
          console.log(`¡${nuevosPedidosDetectados.length} nuevo(s) pedido(s) pendiente(s)!`);
        }
      }
  ...
  const renderPedidoCard = (pedido) => {
    ...
    const tiempoEspera = formatElapsedTime(pedido.created_at);
    const esUrgente = tiempoEspera.includes('h') && parseInt(tiempoEspera.split('h')[0]) > 1;
      ...
      >
        ...
        <div style={{display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start', marginBottom: '12px'}}>
          <div style={{flex: 1}}>
            ...
            <div style={{
              fontSize: '0.9em', 
              color: esUrgente ? '#EF4444' : 'var(--text-secondary)', 
              marginBottom: '4px',
        ...
        {pedido.estado === 'PENDIENTE' && (
          <div style={{display: 'flex', justifyContent: 'center', marginTop: 16}}>
            <button
              onClick={(e) => {
                e.stopPropagation();
                cambiarEstado(pedido, 'EN_PREPARACION');
              }}
              className="admin-btn"
              style={{
                background: esUrgente ? '#EF4444' : '#3B82F6',
                color: '#fff',
                padding: '14px 20px',
                fontWeight: 700,
                fontSize: '1em',
                ...
                minWidth: '100px',
                justifyContent: 'center',
                animation: esUrgente ? 'pulse 1s infinite' : 'none',
                width: '100%'
              }}
            >
              <FiPlay/> {esUrgente ? '¡EMPEZAR YA!' : 'Empezar'}
            </button>
          </div>
        )}
      ...
      <div style={{
        ...
        <div>
          ...
          <div style={{
            ...
            <FiClock size={14}/> {currentTime.toLocaleTimeString('es-CL', { 
              hour: '2-digit', 
              minute: '2-digit' 
            })}
          </div>
      ...
      <div style={{
        ...
        <div style={{
          ...
          <h2 style={{
            ...
            <FiPackage/> Pedidos para Preparar
          </h2>
          <button
        ...
        <div style={{
          ...
          {}
          {pedidos.filter(p => {
            const tiempo = formatElapsedTime(p.created_at);
            return tiempo.includes('h') && parseInt(tiempo.split('h')[0]) > 1;
          }).length > 0 && (
            <div style={{
              background: '#FEE2E2',
              ...
              <div style={{fontSize: '0.8em', color: '#B91C1C', fontWeight: 600}}>
                Urgentes
              </div>
            </div>
          )}
        ...
        {loading ? (
          ...
          <div style={{
            ...
            <p style={{margin: '0 0 24px 0', fontSize: '1.2em'}}>
              No hay pedidos pendientes para preparar en este momento
            </p>
            <div style={{
              background: '#F0F9FF',
              ...
              <ul style={{
                ...
                <li>Mantén tu área de trabajo limpia</li>
                <li>Prepara ingredientes por adelantado</li>
                <li>Revisa el inventario regularmente</li>
          ...
          <div style={{
            ...
            <div>
              ...
              <p style={{
                ...
                {notificationCount} pedido{notificationCount > 1 ? 's' : ''} pendiente{notificationCount > 1 ? 's' : ''}
              </p>
            </div>
          </div>
